...
<body data-target=".navbar" data-spy="scroll" data-offset="0" style="position: relative;">
    ...
    <div class="cont">
        ...
        <div class="container-fluid" id="home" style=" background-image: linear-gradient(to right,#007BFF,#000000);color:white;padding-top: 70px;padding-bottom: 70px;height:400px;">
            ...
            <br>
            <form action="certupload.php" method="post" enctype="multipart/form-data">
                <label for="file">select image to upload : </label><br><br>
                <input class="form-control-file border" type="file" name="file" id="file"><br>
                <input type="submit" style="padding: 7px 15px 7px 15px;background-image: linear-gradient(to right,#ff0066,#cc33ff);border-radius: 25px;margin-bottom:15px;color:white" name="upload_cert" value="upload">
            </form>
        </div>
        <div class="container-fluid" id="home" style=" background-image: linear-gradient(to right,#ff5050,#ff9900);color:white;padding-top: 70px;padding-bottom: 70px;height:400px;">
            ...
            <div>
                <table width="80%" border="1">
                    ...
                    <?php
                    include_once("db.php");
                    $result = mysqli_query($con,"SELECT filename,filetype FROM cert");
                    ?>
                    <?php
                    $i = 0;
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td><a href="youcert/<?php echo $row['filename'] ?>" target="_blank">open</a></td>
                        </tr>
                    <?php
                        $i++;
                    }
